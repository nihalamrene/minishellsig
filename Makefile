...
SRC = main.c signals.c src/lexer/tokenizer_line.c src/tools/lst_addback_m.c \
	 ...
	 src/build_in/my_echo.c src/build_in/unset.c src/build_in/env.c src/build_in/export.c src/build_in/cd.c src/build_in/pwd.c src/build_in/exit.c
...
$(NAME): $(OBJ) $(LIBFT)
	$(CC) $(OBJ) $(F_LFT) -lreadline -fsanitize=address -g3 $(CPPFLAGS) $(LDFLAGS) -o $(NAME)
